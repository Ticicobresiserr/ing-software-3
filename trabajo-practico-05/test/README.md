...
## Development environment and release process
 ...
 - create virtualenv with Flask and test installed into it (latter is installed in
...
install it (`pip install test.tar.gz`), ensure that configuration file exists and
`TEST_SETTINGS` environment variable points to it, ensure that user has access to the
